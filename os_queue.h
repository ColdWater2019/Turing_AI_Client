...
__attribute ((visibility("default"))) OS_BOOL os_queue_is_full(os_queue_handle_t self);
__attribute ((visibility("default"))) OS_BOOL os_queue_is_empty(os_queue_handle_t self);
